# Generated by Django 4.2.18 on 2025-04-10 08:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('titol_original', models.CharField(blank=True, max_length=200, null=True)),
                ('autor', models.CharField(blank=True, max_length=200, null=True)),
                ('CDU', models.CharField(blank=True, max_length=40, null=True)),
                ('signatura', models.CharField(blank=True, max_length=40, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cataleg_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='biblioteca.cataleg')),
                ('ISSN', models.CharField(blank=True, max_length=13, null=True)),
